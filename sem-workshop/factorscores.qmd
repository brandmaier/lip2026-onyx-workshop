...
![](screenshots/onyx-screen-menu-factorscores.png)
...
5.  Save the estimated data set to a file

# Solution

First, create the latent factor model. It should look like this:

![](screenshots/onyx-screen-holzinger-twofactors-correlation2.png)
...
![](screenshots/onyx-screen-holzinger-factorscores.png)
