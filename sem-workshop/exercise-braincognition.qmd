...
Again, quoting from @kievit2014distinct:
...
3.  Create a measurement model for the brain. Does a single factor
    ...
    using two correlated factors? A gray matter volume factor with two    indicators and a white matter factor with two indicators? If not,    what else can we do?
...
Here are some alternative models for the brain variables. First, we model
a single factor:
...
Anegative variance is an indicator for an unsatisfying
