...
2.  Specify an observed-only ANOVA model with three groups to test whether the anger ratings differed across the experimental (protest) groups.
...
anova(lm(sexism ~ protest, psych::Garcia))
```
